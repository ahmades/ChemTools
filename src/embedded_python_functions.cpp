...
namespace CppPy {
  ...
  FunctionP1R2::FunctionP1R2( std::string const& module_path
                              , std::string const& function_name ) {
    Load( module_path, function_name );
  }

  void FunctionP1R2::Load( std::string const& module_path
                           , std::string const& function_name ) {
    ...
    CppPy::Object module_parent_path =
      PyUnicode_FromString( bfsp.parent_path().string().c_str() );
